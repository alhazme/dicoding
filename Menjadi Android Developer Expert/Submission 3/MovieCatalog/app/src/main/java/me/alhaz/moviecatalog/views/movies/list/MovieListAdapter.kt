...
class MovieListAdapter(val context: Context, private var listMovies: ArrayList<Movie>, val clickListener: (Movie) -> Unit) : RecyclerView.Adapter<MovieListViewHolder>() {
