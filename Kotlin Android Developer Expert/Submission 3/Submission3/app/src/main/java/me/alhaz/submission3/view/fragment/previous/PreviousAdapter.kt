package me.alhaz.submission3.view.fragment.previous
...
class PreviousAdapter (val context: Context, private val events: List<Event>, val clickListener: (Event) -> Unit) : RecyclerView.Adapter<EventViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EventViewHolder {

        return EventViewHolder(LayoutInflater.from(context).inflate(R.layout.previous_item, parent, false))
    }
